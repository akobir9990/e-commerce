        ...
        <div className="w-[680px] grid justify-center itecen ">
          ...
          <form action="#" className="grid w-full gap-8">
            <input
              ...
              id=""
              placeholder="Имя*"
              className="w-[680px] h-[50px] rounded-md px-2.5 py-2.5 bg-secondary focus:outline focus:outline-2 focus:outline-[#ededed] border border-[#ededed] focus:border-[none]"
            />
            <input
              type="text"
              name=""
            ...
            <textarea
              ...
              className="w-[680px] h-[115px] rounded-md px-2.5 py-2.5 bg-secondary focus:outline focus:outline-2 focus:outline-[#ededed] border border-[#ededed] focus:border-[none] resize-none"
            ></textarea>
            <button
